...
const SignUpForm = () => {
            ...
            //   Destructure the signUpdata so we dont have to use the dot Notation 
              const {username, password1, password2}= signUpData

            //   Handle errors using the useState
             const [errors, setErrors]=useState({})


            //   This variable(history) enables utomatic redirection to the signin page
              const history=useHistory();

              const handleChange= (event)=> ({
                // We need to spread the previous SignUpData so that we only update our relevent attribute
                  ...setSignUpData({
